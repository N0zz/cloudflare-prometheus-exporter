...
class CloudflareCollector:
    ...
    def __init__(self) -> None:
        ...
        self.firewall_metrics_data: list[
            FirewallEventEntry
        ...
        self.quota_timestamp: float = 0.0
        ...
        if data and zone_name:
            ...
            with self._lock:
                ...
                if new_http_metrics and isinstance(new_http_metrics[0]["sum"], dict):  # type: ignore[typeddict-item]
                    ...
                    new_firewall_metrics[0]["count"],  # type: ignore[reportGeneralTypeIssues]
                    int,  # type: ignore[typeddict-item]
                ):
